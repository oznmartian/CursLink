...
<div class="container">
  ...
  <form method="post" action=""  class="row g-3 needs-validation" novalidate>
        ...
        <input name="prenume" type="text" class="form-control" id="validationCustom02" value="" required>
        <div class="valid-feedback">
            Camp completat corect
        ...
        <input name="datanastere" type="date" class="form-control" id="validationCustom04" value="" required>
        <div class="valid-feedback">
            Camp completat corect
        </div>
